            ...
            <div className="p-6">
              ...
              <div className="text-center mb-5">
                ...
                <p className="text-muted-foreground">
                  87% of men who get this far <span className="text-destructive font-semibold">lose everything in 30 days</span>
                </p>
              </div>

              {/* What happens without */}
              <div className="bg-destructive/5 border border-destructive/20 rounded-xl p-4 mb-5">
                <p className="font-semibold mb-2 text-sm">Without the Emotional Shield:</p>
                <div className="space-y-1.5">
                  {[
                    'They will pull away when you least expect it',
                    'Someone else will take advantage of your work',
                    'You\'ll go back to zero'
                  ].map((item, i) => (
              ...
              <div className="bg-success/5 border border-success/20 rounded-xl p-4 mb-5">
                <p className="font-semibold mb-2 text-sm">Module 3 includes:</p>
                <div className="space-y-1.5">
                  {[
                    '30-day maintenance protocol',
                    'The 5 triggers that keep them obsessed',
                    'How to shield against third parties',
                    'Access to exclusive VIP community'
                  ].map((item, i) => (
                    <div key={i} className="flex items-center gap-2 text-sm">
              ...
              <div className="bg-muted/50 rounded-xl p-4 mb-4 text-center">
                <p className="text-xs text-muted-foreground mb-1">Special price (only now)</p>
                ...
                <p className="text-xs text-success font-medium mt-1">Save $30 if you buy now</p>
              </div>
              ...
              <div className="bg-warning/10 border border-warning/20 rounded-xl p-3 mb-5">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium">This offer expires in:</span>
                </div>
