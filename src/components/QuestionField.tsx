        ...
        {question.type === 'number' && (
          <div className="relative">
            ...
            <input
              ...
              placeholder={question.placeholder || 'E.g.: 5'}
              value={value}
            ...
            <div className="flex justify-between items-center mt-2 text-xs text-muted-foreground">
              {question.minLength && value.length < question.minLength ? (
                <span className="text-warning">
                  Minimum {question.minLength - value.length} more characters
                </span>
              ) : (
                <span className="text-success">✓ Valid length</span>
              )}
      ...
      <AnimatePresence>
        {hasError && (
          ...
          >
            ...
            <span className="text-sm font-medium">This question is required</span>
          </motion.div>
        )}
      </AnimatePresence>
