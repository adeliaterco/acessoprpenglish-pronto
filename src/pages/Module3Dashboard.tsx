        ...
        <div className="container mx-auto px-4 py-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              Your progress in Emotional Shield
            </p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="bg-gradient-to-r from-primary/10 to-success/10 rounded-2xl p-6 mb-8 border border-primary/20">
            <div className="flex flex-col md:flex-row items-center gap-4">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="font-display text-xl font-bold mb-1">Exclusive Community</h3>
                <p className="text-muted-foreground">Access to our elite community with support, webinars and networking</p>
              </div>
              <button onClick={() => alert('Discord/Telegram community link')} className="btn-primary">
                Join the Community
              </button>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="card-premium mb-8">
            <h2 className="font-display text-xl font-semibold mb-4">Your Progress in Module 3</h2>
            <ProgressBar progress={progress} size="lg" showPercentage />
            {progress >= 100 && (
              <div className="mt-4 flex items-center gap-3 text-success">
                <Award className="w-6 h-6" />
                <span className="font-semibold">You've completed the program! Your certificate is available.</span>
              </div>
            )}
          </motion.div>
          ...
          {earnedModule3Badges.length > 0 && (
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }} className="mb-8">
              <h2 className="font-display text-xl font-semibold mb-4">Your Module 3 Badges 🏆</h2>
          ...
          {/* Lessons Grid */}
          <div>
            <h2 className="font-display text-xl font-semibold mb-4">Module 3 Lessons</h2>
